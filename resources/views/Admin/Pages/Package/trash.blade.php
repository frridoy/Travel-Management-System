            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <td>
                            <img style="border-radius: 15%" width="70px" src="{{ url('/uploads/' . $package->image) }}"
                                alt="">
                        </td> --}}
                        {{-- <td>
                            <img style="border-radius: 15%" width="70px" src="{{ asset('uploads/' . $package->image) }}"
                                alt="">
                        </td> --}}
                        <td>

                            <a href="{{route('package.restore',$package->id)}}" class="btn btn-success">Restore</a>
                            <a href="{{route('package.forceDelete',$package->id)}}" class="btn btn-danger">Delete</a>
